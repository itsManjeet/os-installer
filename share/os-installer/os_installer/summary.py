...
class SummaryPage(Gtk.Box, Page):
    ...
    disk_path_label = Gtk.Template.Child()
    disk_format_label = Gtk.Template.Child()
    ...
    def load(self):
        ...
        self.disk_label.set_label(global_state.get_config('disk_name'))
        self.disk_path_label.set_label(
            global_state.get_config('disk_device_path')
        )
        self.disk_format_label.set_visible(
            not global_state.get_config('disk_is_partition')
        )
